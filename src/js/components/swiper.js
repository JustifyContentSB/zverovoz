...
import { Navigation, Pagination, Thumbs, Manipulation, Scrollbar, Autoplay, EffectFade, Grid } from 'swiper/modules';
...
export default class extends Component {
    ...
    getParams = (el, options) => {
        ...
        params.modules = [Navigation, Pagination, Manipulation, Scrollbar, Autoplay, EffectFade, Grid];
